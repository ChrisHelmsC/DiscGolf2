...
public class HomeScreen extends AppCompatActivity
{
    ...
    Button playButton, historyButton, settingsButton;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        historyButton = (Button) findViewById(R.id.my_games_button);
        ...
        settingsButton = (Button) findViewById(R.id.home_settings_button);
